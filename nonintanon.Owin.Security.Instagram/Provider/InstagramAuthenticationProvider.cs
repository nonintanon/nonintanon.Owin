...
namespace nonintanon.Owin.Security.Instagram
{
    ...
    public class InstagramAuthenticationProvider : IInstagramAuthenticationProvider
    {
        ...
        public virtual Task Authenticated(InstagramAuthenticatedContext context) { return OnAuthenticated(context); }
        ...
        /// <returns>A <see cref="Task"/> representing the completed operation.</returns>
        public virtual Task ReturnEndpoint(InstagramReturnEndpointContext context) { return OnReturnEndpoint(context); }
    }
}
